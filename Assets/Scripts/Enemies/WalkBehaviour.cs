...
public class WalkBehaviour : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        foreach (GameObject room in roomList)
        {
            ...
            minX = roomScript.leftDoor.transform.position.x + 5;
            maxX = roomScript.rightDoor.transform.position.x -5;
            minY = roomScript.bottomDoor.transform.position.y + 5;
            maxY = roomScript.topDoor.transform.position.y - 5;
